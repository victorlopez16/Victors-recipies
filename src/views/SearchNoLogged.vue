...
.text-content p { margin: 4px 0 0; font-size: 0.8rem; color: #666; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
...
.no-results h3 { color: #888; margin-top: 10px; }
