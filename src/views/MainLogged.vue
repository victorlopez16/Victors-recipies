      ...
      <div class="main-layout">
        ...
        <div class="static-section">
          ...
          <div class="horizontal-scroll">
            <div 
              ...
              :key="'p-' + index"
              @click="recipe.title === 'Pizza Margarita' ? navegar('/EntradaReceta') : null"
            >
        ...
        <div class="vertical-scroll-area">
          <div 
            ...
            :key="'list-' + index"
            @click="index === 0 ? navegar('/EntradaReceta2') : null"
          >
...
const listadoPrincipal = [
  { 
    title: 'Gofres con miel', 
    description: 'Gofres con miel, plátano y arándanos', 
    image: ArandanosGofres, 
    tags: ['Dulce', 'Saludable']
  },
  { 
    title: 'Tacos Al Pastor', 
    description: 'Deliciosos tacos con piña y cilantro fresco', 
    image: 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?q=80&w=500',
    tags: ['Mexicana', 'Picante']
  },
  { 
    title: 'Pasta Carbonara', 
    description: 'Pasta italiana tradicional con guanciale y huevo', 
    image: 'https://images.unsplash.com/photo-1612874742237-6526221588e3?q=80&w=500',
    tags: ['Italiana', 'Pasta']
  },
  { 
    title: 'Poke Bowl Salmón', 
    description: 'Bowl de arroz con salmón marinado y aguacate', 
