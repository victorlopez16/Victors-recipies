        ...
        <div class="form-container">
            ...
            <div class="steps-container">
              <div class="paso-row" v-for="(_, i) in pasos" :key="'paso-' + i">
                ...
                <div class="input-gray-step">
                  <ion-input v-model="pasos[i]" :placeholder="pasosPlaceholders[i] || 'Siguiente paso...'" class="custom-input-gray"></ion-input>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="tag-input-box">
              <ion-input v-model="nuevoTag" placeholder="Ej: Vegano, Rápido..." class="custom-input-gray" @keyup.enter="agregarTag"></ion-input>
              <ion-button fill="clear" @click="agregarTag"><ion-icon :icon="arrowForwardOutline"></ion-icon></ion-button>
            </div>
            <div class="tags-row">
